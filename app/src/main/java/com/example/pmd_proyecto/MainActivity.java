    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GenerarRetoThread task = new GenerarRetoThread(MainActivity.this);
                new Thread(task).start();
            }
        });

        txtPregunta = findViewById(R.id.main_textview_pregunta);
...
//        startActivity(i);
    ...
    public void mostrarReto(RetoProgramacion reto) {
        // Asignar pregunta
        if (reto == null) {
            txtPregunta.setText("Error: No se pudo generar el reto.");
            return;
        }
